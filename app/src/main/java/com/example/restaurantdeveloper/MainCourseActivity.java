...
public class MainCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_courses_activity);

        ListView mainView = findViewById(R.id.list_view_main);
        Dish [] mysDish = {
        ...
        ArrayAdapter<Dish> dishesAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1,mysDish);

        mainView.setAdapter(dishesAdapter);
    }
}
